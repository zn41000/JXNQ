...
var_lat_data, var_lon_data, var_TMax24_data, var_TMin24_data, var_Ww12_data = f[var_lat][
    :], f[var_lon][:], f[var_TMax24][:], f[var_TMin24][:], f[var_Ww12][:]  # 获取变量的数据
var_lat_data, var_lon_data, var_TMax24_data, var_TMin24_data, var_Ww12_data = np.array(var_lat_data), np.array(
    var_lon_data), np.array(var_TMax24_data), np.array(var_TMin24_data), np.array(var_Ww12_data)  # 转化为np.array数组
var_lon_data, var_lat_data = np.around(var_lon_data, decimals=2), np.around(
    var_lat_data, decimals=2)  # 将经纬度数据统一保留两位小数
...
def findcell(x, y, attribute):  # 规定统一函数，传入定位参数，输出所需位置的属性值
    ...
    week = [attribute_day1, attribute_day2, attribute_day3,
            attribute_day4, attribute_day5, attribute_day6, attribute_day7]
    return week
...
weather = {0: "晴", 1: "多云", 2: "阴", 3: "阵雨", 4: "雷阵雨", 5: "雷阵雨并伴有冰雹", 6: "雨夹雪", 7: "小雨", 8: "中雨", 9: "大雨", 10: "暴雨", 11: "大暴雨", 12: "特大暴雨", 13: "阵雪", 14: "小雪", 15: "中雪", 16: "大雪", 17: "暴雪", 18: "雾", 19: "冻雨", 20: "沙尘暴", 21: "小到中雨", 22: "中到大雨", 23: "大到暴雨", 24: "暴雨到大暴雨", 25: "大暴雨到特大暴雨", 26: "小到中雪", 27: "中到大雪",
           28: "大到暴雪", 29: "浮尘", 30: "扬沙", 31: "强沙尘暴", 32: "尚未编码", 33: "尚未编码", 34: "尚未编码", 35: "尚未编码", 36: "尚未编码", 37: "尚未编码", 38: "尚未编码", 39: "尚未编码", 40: "尚未编码", 41: "尚未编码", 42: "尚未编码", 43: "尚未编码", 44: "尚未编码", 45: "尚未编码", 46: "尚未编码", 47: "尚未编码", 48: "尚未编码", 49: "尚未编码", 50: "尚未编码", 51: "尚未编码", 52: "尚未编码", 53: "霾"}
